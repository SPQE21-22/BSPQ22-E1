...
public interface IRemoteFacade extends Remote {
    long register(String name, String email, String password, Date birthDate, List<Book> books) throws RemoteException;
    ...
    boolean updateBook(String name, String author, Date publishDate, Boolean available) throws RemoteException;
